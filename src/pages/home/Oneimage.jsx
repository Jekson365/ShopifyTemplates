                ...
                {arr.map((each) => {
                    return (
                        ...
                        flex-column align-items-center justify-content-between d-flex text-center '>
                            ...
                            <h3
                                className='h4 text-white  h-100 d-flex align-items-center cursor-pointer flex-row
                            justify-content-center'>Discover <HiArrowLongRight className='fs-3 dascc' /></h3>
                        </SwiperSlide>
                    )
                })}
            </Swiper>
